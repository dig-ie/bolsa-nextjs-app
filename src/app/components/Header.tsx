...
export default function Header({ title = "Valorim", buttonText = "Entrar" }) {
    return (
        <header className="">
            <nav className="flex items-center justify-between w-full h-16 px-4 bg-white text-primaryGreen">
                ...
                <button className="px-2 py-1 font-bold text-black border-primaryGreen border-3 w-26 black rounded-xl text-md">{buttonText}</button>
            </nav>
        </header>
    )
}